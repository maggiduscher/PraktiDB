...
<html>
	<head>
		<?php
			CreateHead("Admin/Lehrer Kontrollraum - Liste aller angenommener bzw. aller nicht angenommener Sch&uuml;ler");
		?>
	</head>
	<body>
            <?php
            ...
            ?>
            <div id="main">
                <h1>Admin/Lehrer Kontrollraum - Liste aller angenommener bzw. aller nicht angenommener Sch&uuml;ler</h1>
